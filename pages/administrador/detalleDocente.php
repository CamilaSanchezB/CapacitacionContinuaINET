...
<body>
    ...
    <div class="container" style="min-height: 75vh;">
        ...
        <div class="col-7 text-break h4 mb-5" style="font-style: normal; color: rgba(56, 56, 56, 0.63) ;">Domicilio: <?php echo $primerElemento['nombre_provincia'] ?></div>
        <h1 class="mt-5" style="color: rgba(129, 129, 129, 1);">Capacitaciones</h1>
        <hr class="col-5">
        <div class="col-7 text-break h5" style="font-style: normal; color: rgba(56, 56, 56, 0.63) ;">Titulo capacitacion 1 </div>
        <div class="col-7 text-break h5 " style="font-style: normal; color: rgba(56, 56, 56, 0.63) ;">Titulo capacitacion 2 </div>
            ...
            if (!empty($listaProvincias)) {
                foreach ($listaProvincias as $provincia) { ?>
                    <li style="margin-bottom: 10px; font-size: 20px;" class="text-primary">
                        <a href='?t=administrador&p=detalleETP&id=<?php echo $provincia['id_provincia'] ?>' class="text-primary">
