...
include('./functions/obtenerIdTipoEducacion.php');
...
<body>
    ...
    if (isset($_POST['crear'])) {
        if (isset($_POST['nombre']) && isset($_POST['tipo_educacion']) && isset($_POST['fecha_inicio']) && isset($_POST['fecha_finalizacion']) && isset($_POST['dias_horarios']) && isset($_POST['modalidad']) && isset($_POST['lugar_plataforma'])) {
            $nombre = $_POST['nombre'];
            $tipo_educacion = obtenerIdTipoEducacion($_POST['tipo_educacion']);
            ...
            try {
                ...
                (`id_institucion`, `id_tipo_educacion`, `nombre_capacitacion`, `fecha_inicio_capacitacion`, `dias_horarios_capacitacion`, `fecha_fin_capacitacion`, `modalidad_capacitacion`, `lugar_o_plataforma_capacitacion`) 
                VALUES (:id_institucion, :tipo_educacion, :nombre, :fecha_inicio, :dias_horarios, :fecha_finalizacion, :modalidad, :lugar_plataforma)");
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group row mt-4 d-flex align-items-center justify-content-start">
                ...
                <div class="col-sm-6">
                    <select class="form-select col-6" name="tipo_educacion" style="height: 6ch;">
                        ...
                        ?>
                            <option value="<?php echo $tipoEducacion['desc_tipo_educacion']; ?>">
            ...
            <div class="form-group row mt-4 d-flex align-items-center justify-content-start">
                <label for="seleccion" class="col-sm-3 col-form-label text-secondary d-flex align-items-center">Modalidad</label>
                <div class="col-sm-6">
            ...
            <div class="form-group row mt-4 d-flex align-items-center justify-content-start">
                <label for="seleccion" class="col-sm-3 col-form-label text-secondary d-flex align-items-center">Lugar/Plataforma</label>
                <div class="col-sm-6">
                    <div class="col-sm-12">
