                ...
                <div class="col-12 d-flex justify-content-center">
                    <form method="POST">
                        ...
                        if ($inscripto_a_capacitacion) { ?>
                            <button class="btn btn-lg btn-danger shadow mb-5" name="BajaInscripcion"
                                value="<?php echo $primerElemento['id_capacitacion'] ?>">Dar de baja inscripcion</button>
                            <?php

                        } else { ?>
                            <button class="btn btn-lg btn-success shadow mb-5" name="AltaInscripcion"
                                value="<?php echo $primerElemento['id_capacitacion'] ?>">Inscribirme</button>
                            <?php
